...
InfoLmpsData calcP2CrystandlocalLammpsData(string lammpsdatafile, double resolutions [3], int nlinesdata, vector <int> coordinateindicies, int backboneBonds, vector <int> backboneAtypes){
	...
	cout << lammpsdatafile << ", " << crystallinityhere << ", " << hermansOrientP2 << endl;
	...
	info.HermansOrientP2 = hermansOrientP2;
	return info;
...
int main(){
	...
	cout << "Datafile, Crystallinity, Hermans Orientation Factor" << endl;
	for (int i =2100000; i <= 3000000; i=i+150000){
	stringstream ss;
        ss << i;
        string num = ss.str();
        string name = "Data" + num +"/snapshot.data";
	
	InfoLmpsData info = calcP2CrystandlocalLammpsData(name, resolutions,770210, coordinateindices, backboneBonds, backboneAtypes);
	}
